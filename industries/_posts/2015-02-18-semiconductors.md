...
![Microprocessor](images/microprosessor-241x332-166x205.jpeg "Microprocessor")Faster, cheaper, and smaller semiconductors have benefited all industries and services, and transformed communications, transportation, and entertainment. Doubling of transistors on integrated circuits has created technological innovation and led to new products, economic growth, productivity gains, and new industries.
...
**![Circuitboard](images/circuitboard-228x214.jpeg "Circuitboard")Microcontrollers:** These are ICs designed for embedded applications in the automotive, communications, appliances, renewable energy systems, power management, medical and industrial equipment, and peripheral equipment for personal computers. &nbsp;They contain a processor core, memory and programmable software and input/output devices. 
...
<div class="field field-type-link field-field-industry-assoications">
    ...
    <div class="field-items">
            <div class="field-item odd">
                    [Global Semiconductor Alliance (GSA)](http://www.gsaglobal.org/)        </div>
              <div class="field-item even">
                    [Semiconductor Industry Association (SIA)](http://www.sia-online.org/)        </div>
              <div class="field-item odd">
                    [Semiconductor Equipment and Materials International (SEMI)](http://www.semi.org/)        </div>
        </div>
</div>
<div class="field field-type-link field-field-industry-publications">
    ...
    <div class="field-items">
            <div class="field-item odd">
                    [EE Times](http://www.eetimes.com/)        </div>
              <div class="field-item even">
                    [Fabtech](http://www.fabtech.org/)        </div>
              <div class="field-item odd">
                    [Solid State Technology](http://www.electroiq.com/index/Semiconductors.html)        </div>
        </div>
</div>