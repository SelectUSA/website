...
;
	function init_rotator() {
		...
		//Define rotating parameters and settings
		var speed = 2000;
		
		//Set up rotate function
		function rotate(element) {
		
		//Gather elements and determine which is next
	...
	function init_toggle() {
		var _infopanel = $('#incentives-search-header');
		if(!_infopanel.length) {			
			//stop function
			return;
		}
		else {
			_infopanel.hide();
			$('#main-inner').prepend('<a class="clicker">Search Instructions</a>');
			$('.clicker').click(function(){
				_infopanel.slideToggle(); 
			});
		}
	}
